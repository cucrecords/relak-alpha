...
class WC_Shortcodes {
	...
	public static function init() {
		$shortcodes = array(
			...
			'woocommerce_new_vendor_reg' => __CLASS__ . '::new_vendor_reg',
		);
	...
	/**
	 * Vendor reg shortcode.
	 *
	 * @param mixed $atts
	 * @return string
	 */
	public static function new_vendor_reg( $atts ) {
		return self::shortcode_wrapper( array( 'WC_Shortcode_New_Vendor_Reg', 'output' ), $atts );
	}
