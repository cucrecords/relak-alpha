	...
	public function vendor_option()
	{
		...
		<p>
			*Required fields<br />
			...
			<input id="apply_for_vendor" <?php checked( isset( $_POST[ 'apply_for_vendor' ] ), true ) ?> type="checkbox" name="apply_for_vendor" value="1"/>
		...
		<p class="agree-to-terms-container" style="display:none">
			...
			<input id="agree_to_terms" <?php checked( isset( $_POST[ 'agree_to_terms' ] ), true ) ?> type="checkbox" name="agree_to_terms" value="1"/>
