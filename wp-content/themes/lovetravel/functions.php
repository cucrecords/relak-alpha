...
add_action('add_meta_boxes', 'toast_is_toast', 99);
function toast_is_toast(){
    //capability of 'manage_plugins' equals admin, therefore if NOT administrator
    //hide the meta box from all other roles on the following 'post_type' 
    //such as post, page, custom_post_type, etc
    if (!current_user_can('activate_plugins')) {
        remove_meta_box('redux-redux_demo-metabox-demo_layout_products', 'product', 'normal');
		remove_meta_box('redux-redux_demo-metabox-layout_products2', 'product', 'side');
...
function nicdark_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/love-travel/wp/plugins/revslider_26.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com//themes/love-travel/wp/plugins/contact-form-7_26.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/love-travel/wp/plugins/wordpress-importer_26.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/love-travel/wp/plugins/js_composer_26.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/love-travel/wp/plugins/nicdark-shortcodes_26.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/love-travel/wp/plugins/woocommerce_26.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
